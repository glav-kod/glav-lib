...
что и для коммитов и pull request'ов (`.claude/rules/language-russian.md`). Технические
идентификаторы — имена файлов, классов, методов, команд, таблиц — остаются на английском
в бэктиках.
