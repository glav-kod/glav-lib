...
#   VERSION_TIMEZONE  идентификатор таймзоны для вычисления даты (например
#                     `Europe/Moscow`); если пусто, берётся таймзона машины.
