...
public class ErrorsSourceGeneratorTests : SourceGeneratorTestsBase
{
    ...
    public void It_should_generate_error_message()
    {
        ...
        const string expected = """
                                ...
                                namespace GlavKod.Tests
                                {
                                    ...
                                    {
                                        public static readonly Error WrongFormat = new("GlavKod.Tests.SystemErrors.WrongFormat", "Неверный формат");
                                    }
                                }
                                """;
                                ...
                                namespace GlavKod.Tests
                                {
                                    public static class SystemErrors
                                    {
                                        public static Error WrongSum(decimal sum)
                                        {
                                            ...
                                            return new Error("GlavKod.Tests.SystemErrors.WrongSum", message.ToString(CultureInfo.InvariantCulture), args);
                                        }
                                    }
                                }
                                """;
    ...
    public void It_should_generate_without_namespace()
    {
        ...
        const string expected = """
                                ...
                                public static class SystemErrors
                                {
                                    public static readonly Error WrongFormat = new("SystemErrors.WrongFormat", "Неверный формат");
                                }
                                """;
